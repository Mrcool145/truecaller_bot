...
def newbt(client,callback_query):
    ...
    if txt=="about":
        callback_query.message.edit(text=f"`Bot`            : [Know Who Bot](t.me/TG_Truecallerbot)\n`Creator :` [Amani Muhammed](t.me/Amani_m_h_d)\n`Language:` [Python3](https://python.org)\n`Library :` [Pyrogram](https://docs.pyrogram.org/) \n`Server  :` [Heroku](https://herokuapp.com/)",
...
def about(client, message):
    client.send_message(chat_id=message.chat.id, reply_to_message_id=message.message_id,
                        text=f"`Bot`            : [Know Who Bot](t.me/TG_Truecallerbot)\n`Creator :` [Amani Muhammed](t.me/Amani_m_h_d)\n`Language:` [Python3](https://python.org)\n`Library :` [Pyrogram](https://docs.pyrogram.org/) \n`Server  :` [Heroku](https://herokuapp.com/)",
                        disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("Feedback", url="t.me/Amani_m_h_d")]]))
